...
//** driverDetails */
      ...
      externalDetails.isBooking!?SizedBox(): BlocBuilder<TripCubit, TripState>(builder: (context, state) {
                ...
                : GestureDetector(
                    onTap: () {
                        ...
                        TripCubit.get(context).addBooking(
                            ...
                            externalTripId: externalDetails.trip!.id,
                            context: context);
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: Text(
                         externalDetails.isBooking!?statusTrip[1] :statusTrip[0],
                          style: TextStyle(
                              fontFamily: 'Segoe UI',
                              fontSize: 20,
