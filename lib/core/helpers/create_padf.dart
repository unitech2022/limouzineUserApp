...
// final Uint8List fontData = File('arial.ttf').readAsBytesSync();
  ...
  final data = await rootBundle.load('assets/fonts/alex_bold.ttf');
...
// Save the document.
  ...
  // File(appDocDirectory.path + '/trip.pdf').writeAsBytes(await document.save());
